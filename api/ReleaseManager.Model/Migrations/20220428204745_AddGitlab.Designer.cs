...
namespace ReleaseManager.Model.Migrations
{
    ...
    [Migration("20220428204745_AddGitlab")]
    partial class AddGitlab
    {
            ...
            modelBuilder.Entity("ReleaseManager.Model.Models.App", b =>
                {
                    ...
                    b.Property<int?>("GitlabCredentialId")
                        .HasColumnType("integer")
                        .HasColumnName("gitlab_credential_id");
                    ...
                    b.HasIndex("GitlabCredentialId")
                        .HasDatabaseName("ix_apps_gitlab_credential_id");
            ...
            modelBuilder.Entity("ReleaseManager.Model.Models.GithubCredential", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_github_credential");

                    b.ToTable("github_credential", (string)null);
                });

            modelBuilder.Entity("ReleaseManager.Model.Models.GitlabCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gitlab_credential");

                    b.ToTable("gitlab_credential", (string)null);
                });
            ...
            modelBuilder.Entity("ReleaseManager.Model.Models.App", b =>
                {
                    b.HasOne("ReleaseManager.Model.Models.GithubCredential", "GithubCredential")
                        ...
                        .HasConstraintName("fk_apps_github_credential_git_hub_credential_id");

                    b.HasOne("ReleaseManager.Model.Models.GitlabCredential", "GitlabCredential")
                        .WithMany()
                        .HasForeignKey("GitlabCredentialId")
                        .HasConstraintName("fk_apps_gitlab_credential_gitlab_credential_id");

                    b.Navigation("GithubCredential");

                    b.Navigation("GitlabCredential");
                });
